...
#
# _PLANT_LON_WEIGHT = 2.0:
#   kick_inside_contact (4.0) より下に置く。**軸足の位置は「型」の指定であって
#   このタスクの目的そのものではない**ため。当たり所 (インサイドで当てる) が目的で、
#   軸足はその型を安全側へ寄せるための補助。middle の kick_plant_foot が 2.0 に
#   抑えられていたのとまったく同じ位置づけ。
#
