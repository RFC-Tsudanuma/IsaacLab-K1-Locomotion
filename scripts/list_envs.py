...
All the environments are registered in the `isaaclab_k1_locomotion` extension. They start
...
def main():
    """Print all environments registered in `isaaclab_k1_locomotion` extension."""
