...
#                                                                 # (walk phase が無ければ
#                                                                 #  stage 1 から自動で回る)
#   STAGE=1234 ./scripts/rsl_rl/train_walk_kick_weak_dual.sh      # walk phase から必ず回す
#   WALK_ITER=8000 ./scripts/rsl_rl/train_walk_kick_weak_dual.sh  # stage 1 の iteration
